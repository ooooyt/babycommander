...
public enum MessageKey {
    ...
    CHAT_HELP_CONFIG("chat.help.config", "    /config            Show effective configuration"),
    CHAT_CONFIG_HEADER("chat.config.header", "\n--- Effective configuration ---"),
    CHAT_CONFIG_DEFAULT_MODEL("chat.config.default_model", "Default model: {0}"),
    CHAT_CONFIG_PROVIDER("chat.config.provider", "Provider [{0}] type={1} model={2} baseUrl={3} apiKey={4}"),
    CHAT_CONFIG_ROLE("chat.config.role", "Role [{0}] provider={1}"),
